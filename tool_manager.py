...
TOOL_METADATA: Dict[str, ToolMetadata] = {
    ...
    "WebFetch": ToolMetadata(
        ...
        parameters={
            ...
            "prompt": "Prompt to process the content"
        },
        examples=[
    ...
    "TodoWrite": ToolMetadata(
        ...
        parameters={
            "todos": "Array of todo items with content, status, and activeForm"
        },
        examples=[
    ...
    "BashOutput": ToolMetadata(
        ...
        examples=[
            "Check output of running process",
    ...
    "KillShell": ToolMetadata(
        ...
        category="system",
        parameters={
            "shell_id": "ID of the shell to kill"
        },
        examples=[
            "Stop long-running background process"
        ],
        is_safe=True,
        requires_network=False
    ),
    "Skill": ToolMetadata(
        ...
        examples=[
            "Execute PDF processing skill",
            "Run Excel manipulation skill"
        ],
        is_safe=True,
        requires_network=False
    ),
    "SlashCommand": ToolMetadata(
        ...
        category="productivity",
        parameters={
            "command": "Slash command with arguments"
        },
        examples=[
            "Run custom code review command",
...
class ToolConfiguration:
    ...
    def update(self, allowed_tools: Optional[List[str]] = None,
               disallowed_tools: Optional[List[str]] = None):
...
class ToolManager:
    ...
    def update_global_config(self, allowed_tools: Optional[List[str]] = None,
                           disallowed_tools: Optional[List[str]] = None) -> ToolConfiguration:
        """Update the global tool configuration."""
        with self.lock:
            self.global_config.update(allowed_tools, disallowed_tools)
            logger.info(f"Updated global tool config: allowed={allowed_tools}, disallowed={disallowed_tools}")
            return self.global_config
    ...
    def set_session_config(self, session_id: str,
                          allowed_tools: Optional[List[str]] = None,
                          disallowed_tools: Optional[List[str]] = None) -> ToolConfiguration:
    ...
    def get_stats(self) -> Dict:
        ...
        with self.lock:
            return {
                ...
                "global_allowed": len(self.global_config.allowed_tools) if self.global_config.allowed_tools else 0,
                "global_disallowed": len(self.global_config.disallowed_tools) if self.global_config.disallowed_tools else 0,
                ...
                "tool_categories": {
                    ...
                    "productivity": len([t for t in TOOL_METADATA.values() if t.category == "productivity"]),
